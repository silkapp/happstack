module Happstack.MACID.Saver.Impl.S3(S3.AccessKey,S3.SecretKey,s3Saver) where

import Happstack.MACID.Saver.Types
import Happstack.MACID.Saver.Impl.Queue
import Happstack.Protocols.S3 as S3
